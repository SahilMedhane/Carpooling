...
import 'package:project/views/payment.dart';
...
class _DriverHomeScreenState extends State<DriverHomeScreen> {
  ...
  static const CameraPosition _kGooglePlex = CameraPosition(
    target: LatLng(18.45822326613409, 73.8309710484954),
    zoom: 14.4746,
  );
        ...
        child: Form(
          ...
          child: Stack(
            children: [
              ...
              buildProfileTitle(),
              // if(authController.myDriver.value.verified == true) buildTextField() else pendingWidget(),
              buildTextField(),
